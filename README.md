...
Les versions en .accdb sont destinées à l'apprentissage, pour comprendre un SGBD, apprendre à créer ses indicateurs ou pour tester l'ajout de fonctionalités avant de les proposer aux éditeurs. Il est fortement déconseillé d'utiliser ces versions en routine pour le suivi des équipements médicaux, vos modifications pouvant altérer le fonctionnement de la base. 
       _________________________________________________________________________________________________________________________________________________________________________________________
